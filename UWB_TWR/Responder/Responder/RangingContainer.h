class Ranging {
  public:
    ...
    void print_all_time_fast(uint32_t out) {
      char buff[200];
      sprintf(buff, "Ra:%8f Da:%8f Rb:%8f Db:%8f Dist:%d", Ra.getAsMicroSeconds(), Da.getAsMicroSeconds(), Rb.getAsMicroSeconds(), Db.getAsMicroSeconds(), out);
      Serial.println(buff);
